  ...
  return (
    <>
      <div onClick={handleOpenPopup} className={classes.sideProfile}>
        <Avatar src='https://pbs.twimg.com/profile_images/929249594671861760/otbRHtjA_bigger.jpg' />

        <div className={classes.sideProfileInfo}>
          <b>Evgeniy Nechetov</b>
          <Typography style={{ color: colors.grey[500] }}>@EvgeniyNec</Typography>
        </div>
        <ArrowBottomIcon />
      </div>
      <Popover
